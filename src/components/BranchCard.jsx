    ...
    >
      ...
      <div
        style={{
          ...
          paddingTop: 16,
          borderTop: `1px solid ${
            isHQ ? "rgba(255,255,255,0.14)" : "var(--line)"
          }`,
          position: "relative",
        }}
      >
        <div
          style={{
            ...
            background: isHQ
              ...
              : "var(--branch-icon-bg)",
            border: `1px dashed ${isHQ ? "rgba(255,255,255,0.3)" : COLOR.teal + "66"}`,
            display: "flex",
            alignItems: "center",
            justifyContent: "center",
          }}
        >
          {branch.managerPhoto ? (
            <img
              ...
              alt={branch.managerName || `${branch.name} manager`}
        ...
        <div>
          ...
          >
            {branch.managerName || "Manager TBA"}
          </div>
          <div
            style={{
              fontSize: 11.5,
              ...
              color: isHQ ? "rgba(255,255,255,0.6)" : "var(--muted)",
            }}
          >
            Branch Manager
          </div>
